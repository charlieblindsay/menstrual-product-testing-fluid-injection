...
int num_loops_before_fluid_reaches_body_temperature = 2000;

// TODO: change the datatypes of these to int
double initial_temperature_setpoint = 46;
double temperature_setpoint = 37.6;
double body_temperature = 37.5;
double initial_PID_output = 150;
double temperature_adjustment = 48.6;
